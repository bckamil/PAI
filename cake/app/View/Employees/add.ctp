...
<?php echo $this->Form->create('Employee'); ?>
	...
	<?php
		$options = array('DYREKTOR' => 'DYREKTOR','PROFESOR' => 'PROFESOR','ADIUNKT' => 'ADIUNKT','SEKRETARKA' => 'SEKRETARKA','DOKTORANT' => 'DOKTORANT','ASYSTENT' => 'ASYSTENT');
		echo $this->Form->input('nazwisko');
		echo $this->Form->input('imie');
		echo $this->Form->input('etat', 
			array('options'=>$options, 'default'=>'DOKTORANT'));
